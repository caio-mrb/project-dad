...
<template>
  <Card class="w-[450px] mx-auto my-8 p-4 px-8">
    ...
    <CardFooter class="flex justify-between px-6 pb-6">
        ...
        <Button class="bg-purple-600" @click="login">
            Login
        </Button>
    </CardFooter>

    <RouterLink to="signup" class="font-semibold text-1xl text-purple-600 hover:underline">Don't have an account?</RouterLink>
  </Card>
</template>